    ...
    <div class="row">
        <div class="col-sm-7 head-search">
            <div class="input-group m-auto">
                    <input type="text" class="form-control search-bar" placeholder="Nombre de la carrera" aria-label="Search something..." aria-describedby="button-submit">
        ...
        <div class="col-sm-11 d-flex container-categories">
            <div class="row select-box">
                ...
                <div class="options-container">
                    <div class="col option"><a href="#">Diseño Grafico</a></div>
                    <div class="col option"><a href="#">Diseño UX</a></div>
                    <div class="col option"><a href="#">Desarrollo Web</a></div>
                    <div class="col option"><a href="#">Manejo de Base de Datos</a></div>
                    <div class="col option"><a href="#">Manejo de servidores</a></div>
                </div>
            </div>
        </div>
    </div>
